<!-- Sidebar Partial -->
<!-- Font Awesome (Ensure this is included in parent or here) -->
...
<!-- Button with inline onclick for reliability -->
<button class="mobile-toggle" id="btnToggle" onclick="toggleSidebarMenu()">
    <i class="fa-solid fa-bars"></i>
</button>

<div class="sidebar-overlay" id="overlay" onclick="toggleSidebarMenu()"></div>

<div class="sidebar" id="sidebarMenu">
    <button class="close-sidebar" id="btnClose" onclick="toggleSidebarMenu()">
