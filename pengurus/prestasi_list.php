...
<head>
    ...
    <style>
        ...
        .carousel-img {
            height: 70vh; object-fit: contain; background: black;
        }
    </style>
</head>
<body class="bg-light">
    ...
    <div class="main-content" style="margin-left: 260px; padding: 20px;">
        <div class="container-fluid">
            <h2 class="mb-4 text-primary fw-bold"><i class="fas fa-trophy me-2"></i>Kelola Prestasi Mahasiswa</h2>
            
            <a href="prestasi_form.php" class="btn btn-primary mb-3 shadow-sm">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content bg-transparent border-0 shadow-none">
                ...
                <div class="modal-body p-0">
                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="false"> <!-- No auto slide -->
    ...
    <script>
        function openGallery(images, title) {
            ...
            // Show Nav buttons only if multiple images
