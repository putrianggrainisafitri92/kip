...
<head>
    <meta charset="UTF-8">
    <title>Validasi Pedoman - Kabag Akademik</title>
...
<div class="content">
    ...
    <div class="search-box">
        <input type="text" id="searchInput" class="search-input" placeholder="Cari Pedoman...">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;">
                        <a href="validasi_pedoman_detail.php?id=<?= $id ?>" class="btn btn-detail">
                ...
                <?php if(mysqli_num_rows($q) == 0): ?>
                    <tr><td colspan="4" style="text-align:center; padding: 40px; color: #999; font-style: italic;">Belum ada pedoman.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
